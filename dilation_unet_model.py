...
#The down sample branch of RGB branch and H branch
    def __init__(self,input_channels):
        ...
        self.unetdown1      = DoubleConv(input_channels, channels_[0])
...
#The up sample branch of RGB branch and H branch
    ...
    def forward(self,down_features):
        ...
        print("down_features[0]:",down_features[0].size())
        ret3 = self.up256(ret2,down_features[0])
        
        out = torch.sigmoid(self.out(ret2))
...
#segmentation branch for down sample of the Triple U-net
    def __init__(self):
        ...
        self.down_sample1=unet_block(channels_[0], channels_[1])
        
        self.down_sample2=down_sample(channels_[1], channels_[2])
        self.down_sample3=down_sample(channels_[2], channels_[3])
    ...
    #features_rgb :is a list of RGB branch feature with different resolution
        ...
        ret2   = [self.down_sample1(ret1),features_h[1],features_rgb[1]]
        ret2   = self.PDFA2(ret2)

        ret3   = [self.down_sample2(ret2),features_h[2],features_rgb[2]]
        ret3   = self.PDFA3(ret3)
        
        ret4   = [self.down_sample3(ret3),features_h[3],features_rgb[3]]
