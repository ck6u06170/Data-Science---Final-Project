...
if __name__=='__main__':
    ...
    img_pth = "/home/ma/Pytorch-Medical-Segmentation/data/DS_Public/"
    save_pth = "/home/ma/Pytorch-Medical-Segmentation/data/DS_Public_normalize/"
    allFileList = os.listdir(img_pth)
    for file in allFileList:
      image_filepath = img_pth+file
      print(file)
      img = np.array(Image.open(image_filepath))
    
      normalizeStaining(img = img,
                        saveFile = save_pth+file,
                        Io = 240,
                        alpha = 1,
                        beta = 0.15)